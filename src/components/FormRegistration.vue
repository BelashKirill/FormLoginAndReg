<template>
    <div class="wrapper-form">
        <form>
            <div class="mb-4">
                <label for="exampleInputEmail1" class="form-label">Форма регистрации</label>
                ...
                <div id="emailHelp" class="form-text" v-if="isLogin" :class="{'warning-text': isLogin}">{{messageEmail}}</div>
            </div>
            <div class="mb-4">
                ...
                <div id="emailHelp" class="form-text" v-if="isLogin" :class="{'warning-text': isLogin}">{{messagePassword}}</div>
                <div id="emailHelp" class="form-text"></div>
            </div>
            <div class="wrap-button">
              <button type="submit" class="btn btn-primary" @click.prevent="isLogin">Регистрация</button>
